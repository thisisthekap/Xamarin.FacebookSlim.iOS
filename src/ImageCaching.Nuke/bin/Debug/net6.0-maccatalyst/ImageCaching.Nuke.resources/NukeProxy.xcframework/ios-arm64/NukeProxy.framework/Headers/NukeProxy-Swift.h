...
#ifndef NUKEPROXY_SWIFT_H
#define NUKEPROXY_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="NukeProxy",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

SWIFT_CLASS_NAMED("DataLoader")
@interface DataLoader : NSObject
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) DataLoader * _Nonnull shared;)
+ (DataLoader * _Nonnull)shared SWIFT_WARN_UNUSED_RESULT;
- (void)removeAllCachedResponses;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS_NAMED("ImageCache")
@interface ImageCache : NSObject
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) ImageCache * _Nonnull shared;)
+ (ImageCache * _Nonnull)shared SWIFT_WARN_UNUSED_RESULT;
- (void)removeAll;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS_NAMED("ImagePipeline")
@interface ImagePipeline : NSObject
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) ImagePipeline * _Nonnull shared;)
+ (ImagePipeline * _Nonnull)shared SWIFT_WARN_UNUSED_RESULT;
